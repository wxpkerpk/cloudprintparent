...
*/
    ...
    var Popover = Class.extend({
        ...
        // Triggered when the member clicks *anywhere* in the document, for the autoHide feature
...
// TODO: very useful to have a handler that gets called upon cellOut OR when dragging stops (for cleanup)
    ...
    var DragListener = Class.extend({
        ...
        // Call this when the member does a mousedown. Will probably lead to startListening
        ...
        // Called when the member moves the mouse
        ...
        // Called when the member does a mouseup
        mouseup: function (ev) {
            this.stopDrag(ev);
        ...
        // Call this to stop listening to the member's mouse events
...
----------------------------------------------------------------------------------------------------------------------*/
    ...
    var MouseFollower = Class.extend({
        ...
        // Gets called when the member moves the mouse
        mousemove: function (ev) {
...
----------------------------------------------------------------------------------------------------------------------*/
    ...
    Grid.mixin({
        ...
        mousedOverSeg: null, // the segment object the member's mouse is over. null if over nothing
        ...
        destroyEvents: function () {
            this.triggerSegMouseout(); // trigger an eventMouseout if member's mouse is over an event
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        // Called when the member does a mousedown on an event, which might lead to dragging.
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        // Called when the member does a mousedown on an event's resizer, which might lead to resizing.
        // Generic enough to work with any type of Grid.
    ...
    DayGrid.mixin({
        ...
        showSegPopover: function (cell, moreLink, segs) {
            ...
            options = {
                ...
                autoHide: true, // when the member clicks elsewhere, hide the popover
...
----------------------------------------------------------------------------------------------------------------------*/
    ...
    var View = fc.View = Class.extend({
        ...
        isSelected: false, // boolean whether a range of time is member-selected or not
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        // Computes the new date when the member hits the prev button, given the current date
        ...
        // Computes the new date when the member hits the next button, given the current date
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        // Sets the scroll value of the scroller to the initial pre-configured state prior to allowing the member to change it
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        // Computes if the given event is allowed to be dragged by the member
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        // Computes if the given event is allowed to be resize by the member
	...
	------------------------------------------------------------------------------------------------------------------*/
        ...
        // Handler for unselecting when the member clicks something and the 'unselectAuto' setting is on
        documentMousedown: function (ev) {
            var ignore;

            // is there a selection, and has the member made a proper left click?
	...
	-----------------------------------------------------------------------------*/
        ...
        function refetchEvents() { // can be called as an API method
            destroyEvents(); // so that events are cleared before member starts waiting for AJAX
